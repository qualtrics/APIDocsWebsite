export function getRedirect(path: string, anchor: string) {
  let redirectMap = new Map([
    ...
    [
      ...
      "/ZG9jOjExODQ3OTI-additional-security",
    ],
    [
      "/docs/Instructions/api-key-authentication.md",
      "/ZG9jOjg3NjYzMg-api-key-authentication",
    ],
    [
      "/docs/Instructions/base-url-and-datacenter-ids.md",
      "/ZG9jOjg3NjYzMw-base-url-and-datacenter-i-ds",
    ],
    [
      "/docs/Instructions/dates-and-times.md",
      "/ZG9jOjg3NjYzNA-dates-and-times",
    ],
    [
      "/docs/Instructions/finding-your-qualtrics-ids.md",
      "/ZG9jOjg3NjYzNQ-finding-your-qualtrics-i-ds",
    ],
    ...
    [
      ...
      "/ZG9jOjg3NjYzOA-o-auth-authentication-auth-code",
    ],
    [
      "/docs/Instructions/oauth-authentication.md",
      "/ZG9jOjg3NjYzOQ-o-auth-authentication-client-credentials",
    ],
    ...
    [
      ...
      "/ZG9jOjg3NzY5NA-api-quick-start",
    ],
    [
      "/docs/Instructions/Quick Start/things-to-know-about-the-api.md",
      "/ZG9jOjg3NzY5NQ-things-to-know-about-the-api",
    ],
